...
def-env activate-virtualenv [] {
    ...
    let virtual-env = 'C:\Users\Test\Downloads\EverythngAbby\zuri\DJANGO_REST\venv'
    let bin = 'Scripts'
    let path-sep = ';'
...
alias deactivate = source 'C:\Users\Test\Downloads\EverythngAbby\zuri\DJANGO_REST\venv\Scripts\deactivate.nu'
